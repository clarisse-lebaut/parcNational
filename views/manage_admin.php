                        ...
                        <tr>
                            ...
                            <td>
                                <form method="GET" action="create_admin">
                                    <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($admins['user_id']); ?>">    
                                    <button class="edit-button" type="submit" aria-label="Éditer l'administrateur">
                                        <img src="assets/icon/edit.svg" alt="icon edit">
                                    </button>
                                </form>
                            </td>
                            <td>
                                <form method="POST" action="manage_admin" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet administrateur ?');">
                                    <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($admins['user_id']); ?>">    
                                    <button class="del-button" aria-label="Supprimer l'administrateur">
