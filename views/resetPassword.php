            ...
            <div class="form-container">
                <form method="POST" action="/parcNational/reset-password" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="new_password" id="inputPassword" required autocomplete="new-password">
                    </div>
                    
                    <div class="form-group">
                        <label for="inputRepeatPassword"><p>Répétez le mot de passe</p></label>
                        <input type="password" name="repeat_password" id="inputRepeatPassword"  required autocomplete="new-password">
