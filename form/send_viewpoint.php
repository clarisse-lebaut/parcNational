...
function importCsvToDatabase($fileTmpName, $pdo) {
    if (($handle = fopen($fileTmpName, "r")) !== FALSE) {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
            ...
            $sql = "INSERT INTO viewpoints (type, part_number, coordinate_number, longitude, latitude)
                    VALUES (:type, :part_number, :coordinate_number, :longitude, :latitude)";
...
<body>
    <h1>Importer CSV point de vue dans BDD</h1>

    <form action="send_viewpoint.php" method="post" enctype="multipart/form-data">
