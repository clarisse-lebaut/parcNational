...
function importCsvToDatabase($fileTmpName, $pdo) {
    if (($handle = fopen($fileTmpName, "r")) !== FALSE) {
        ...
        while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
            ...
            $sql = "INSERT INTO trails (type, part_number, coordinate_number, mystery_number, longitude, latitude)
...
<body>
    <h1>Importer CSV un sentier dans une seule table dans BDD</h1>
